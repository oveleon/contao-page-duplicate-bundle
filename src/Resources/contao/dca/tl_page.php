...
$GLOBALS['TL_DCA']['tl_page']['palettes']['duplicate'] = '{title_legend},title,alias,type;{meta_legend},pageTitle,robots,description,serpPreview;{duplicate_legend},jumpTo;{protected_legend:hide},protected;{cache_legend:hide},includeCache;{chmod_legend:hide},includeChmod;{expert_legend:hide},cssClass,sitemap,hide,noSearch;{tabnav_legend:hide},tabindex,accesskey;{publish_legend},published,start,stop';
